...
export const slides = [
  ...
  },
  {
    n: 2,
    slug: "why-small",
    title: "Why Build a Tiny GPT",
    type: "Motivation",
    layout: "binary-comparison",
    goal: "Explain why a tiny model is useful for learning.",
    headline: "Small is easier to see",
    subline: "The same ideas appear in large GPTs, but here every tensor can be opened.",
    bullets: ["Large GPT: powerful but hidden", "Mini-GPT: weak but inspectable", "Same path: tokens -> vectors -> logits"],
    visual:
      "Side-by-side blueprint comparison: a large opaque server block on the left and an open tiny model diagram on the right.",
    labels: ["large GPT", "Mini-GPT", "inspect"],
    notes: [
  ...
  },
  {
    ...
    goal: "Make the task concrete before theory.",
    headline: "We generate names one character at a time",
    subline: "Prompt: den -> model samples n -> i -> s -> stop.",
    bullets: ["Input: a short prefix", "Output: one next character", "Repeat until stop"],
    visual:
      "A left-to-right generation trace showing BOS, d, e, n, then sampled n, i, s, and BOS as stop.",
    labels: ["BOS", "d", "e", "n", "n", "i", "s", "stop"],
    notes: [
    ...
    code: ["src/train.py: generate_name"],
  },
  {
    n: 4,
    slug: "function-view",
