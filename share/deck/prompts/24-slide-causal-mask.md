...
Slide content:
- Slide number for internal tracking only: 24
- Filename: 24-slide-causal-mask.png
- Type: Attention
- Layout: comparison-matrix
- Narrative goal: Explain why GPT cannot look right during training.
- Headline text to render: "The model must not cheat"
- Supporting text to render: "Position t can only read positions <= t."
- Small labels to render only where useful: allowed, blocked, future
- Visual description: Lower-triangular causal mask matrix for tokens BOS d e n n, with allowed cells glowing cyan and blocked cells dark.
- Key points to show visually: Training sees full sequences | Mask hides future tokens | Generation stays left-to-right
