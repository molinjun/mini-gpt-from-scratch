...
Slide content:
- Slide number for internal tracking only: 12
- Filename: 12-slide-tiktoken-example.png
- Type: Tokenizer
- Layout: binary-comparison
- Narrative goal: Compare subword tokenization to character tokenization.
- Headline text to render: "Real GPTs often use subword tokens"
- Supporting text to render: "I love CIS may become a few word pieces, not characters."
- Small labels to render only where useful: I,  love,  CIS, I, l, o, v, e, CIS
- Visual description: Side-by-side tokenizer comparison for the phrase I love CIS: subword chunks on one side, character chunks on the other.
- Key points to show visually: tiktoken style: word pieces | Mini-GPT style: characters | Both output integer ids
