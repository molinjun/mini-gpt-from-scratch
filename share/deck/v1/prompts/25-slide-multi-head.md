...
Slide content:
- Slide number for internal tracking only: 25
- Filename: 25-slide-multi-head.png
- Type: Attention
- Layout: three-columns
- Narrative goal: Explain why multiple heads are useful.
- Headline text to render: "Several heads read in several ways"
- Supporting text to render: "One head may track spelling, another may track endings."
- Small labels to render only where useful: head 1, head 2, head 3, merge
- Visual description: Three parallel attention head lanes over the same Dennis token sequence, each with a different highlighted relation.
- Key points to show visually: Split channels | Run attention in parallel | Merge heads back
