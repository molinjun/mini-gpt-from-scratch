...
Slide content:
- Slide number for internal tracking only: 04
- Filename: 04-slide-function-view.png
- Type: Neural Network Basics
- Layout: linear-progression
- Narrative goal: Start from the simplest mental model of a neural network.
- Headline text to render: "Numbers go in, scores come out"
- Supporting text to render: "A neural network is a function with parameters."
- Small labels to render only where useful: x, parameters, scores
- Visual description: Clean function box diagram: input vector x enters f(x; theta), output scores leave the box, with theta shown as adjustable knobs.
- Key points to show visually: Input numbers | Parameter weights | Output scores
