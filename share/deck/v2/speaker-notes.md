# Mini-GPT Deck V2 Speaker Notes
...
Here is the plan for the talk. We will move through five parts. First, why we build Mini-GPT. Second, the neural network basics we need. Third, tokenizer and embedding. Fourth, the Transformer architecture itself. Finally, we will train the model and use it to generate names.
