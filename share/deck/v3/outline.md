...
| 20 | Attention Intuition | Transformer Architecture | 20-slide-attention-intuition.png |
| 21 | Q, K, V Roles | Transformer Architecture | 21-slide-q-k-v-roles.png |
| 22 | Scores and Softmax | Transformer Architecture | 22-slide-scores-and-softmax.png |
| 23 | Causal Mask | Transformer Architecture | 23-slide-causal-mask.png |
| 24 | Multi-Head Attention | Transformer Architecture | 24-slide-multi-head-attention.png |
| 25 | RMSNorm and Residuals | Transformer Architecture | 25-slide-rmsnorm-and-residuals.png |
| 26 | The MLP Block | Transformer Architecture | 26-slide-the-mlp-block.png |
| 27 | Linear Head to Logits | Transformer Architecture | 27-slide-linear-head-to-logits.png |
